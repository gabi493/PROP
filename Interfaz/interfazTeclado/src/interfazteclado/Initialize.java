...
public class Initialize extends javax.swing.JFrame {
    ...
    int[] vprueba = {2, 0, 1, 3, 4, 5, 6, 7}; 
                //  c, a, b, d, e, f, g, h 
    String disp = "ABECEDARIO";
    ...
    public void recibirAlfabeto(alfabeto alf) {
        this.alf = alf;
        lalfabeto.setText(alf.getNombreAlfabeto());
        for (int i = 0; i < alf.getNumCaracteres(); i++) {
            System.out.println(alf.getSimbolo(i).getInfo());
        }
    }
    ...
    private void initComponents() {
        ...
        lalfabeto = new javax.swing.JLabel();
        ...
        btVisualizacion.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btVisualizacionActionPerformed(evt);
            }
        });
        ...
        jRadioButton1.setText("B&B Clasico");
        ...
        jRadioButton2.setText("B&B con Poda");

        jRadioButton3.setText("B&B Gilmore sin Poda");

        jRadioButton4.setText("B&B Gilmore con Poda");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(btVisualizacion))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(28, 28, 28)
                                .addComponent(lbMsg, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void error (String texto) {
        mnCjtoTextos.setSelected(false);
    ...
    private void mnCjtoTextosMenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_mnCjtoTextosMenuSelected
        if (alf.getNombreAlfabeto() == null)   error("Primero se tiene que seleccionar un alfabeto");
        else {
            Initialize.this.setVisible(false);
            configurarCTextos confCT = new configurarCTextos(Initialize.this, alf);
    ...
    private void mnAlfabetoMenuSelected(javax.swing.event.MenuEvent evt) {//GEN-FIRST:event_mnAlfabetoMenuSelected
        Initialize.this.setVisible(false);
        configurarAlfabeto confAlf = new configurarAlfabeto(Initialize.this, alf);
    ...
    public void finalitzar() {
        JFrame frame = new JFrame("FinalView");//NombreVentana
        frame.getContentPane().setLayout(new BoxLayout(frame.getContentPane(), BoxLayout.Y_AXIS));//Objetos verticalmente
        JPanel teclas = new JPanel();//Panel teclas
        teclas.setAlignmentX(CENTER_ALIGNMENT);//Centrada
        teclas.setLayout(new GridLayout(4,4));//Tamany cuadricula
        frame.add(teclas);//afegir al frame
        visualizar disposicioFinal= new visualizar(Initialize.this, disp, teclas); //crear clase visualizar
        frame.setSize(800,600);
        //frame.setExtendedState(JFrame.MAXIMIZED_BOTH); //maximizado
        JPanel panelBotones = new JPanel(); //Panel botones
        panelBotones.setLayout(new FlowLayout());
        panelBotones.add(new JButton("Aceptar"));
        panelBotones.add(new JButton("Cancelar"));
        panelBotones.add(new JButton("Cambiar Teclas"));
        frame.add(panelBotones);
        disposicioFinal.disposicion();//executar metode q coloca les tecles
        System.out.println("Ye");
        frame.setVisible(true);
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//finaliza el programa cuando se da click en la X          
    }
    
    private void btVisualizacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btVisualizacionActionPerformed
        // TODO add your handling code here:
        /*visualizar vis = new visualizar(Initialize.this, alf, vprueba, tec);
        vis.setVisible(true);
        Initialize.this.setVisible(false);*/
        if (alf.getNombreAlfabeto() == null || conjuntoT == null || tec == null) {
        if (alf.getNombreAlfabeto() == null)   error("Se tiene que seleccionar un alfabeto");
        else if (conjuntoT == null) error ("Se tiene que seleccionar un conjunto de textos");
        else if (tec == null) error ("Se tiene que seleccionar un teclado");
        }
        else {
         Initialize.this.setVisible(false);
        finalitzar();
        }
    }//GEN-LAST:event_btVisualizacionActionPerformed
    ...
    private javax.swing.JLabel lalfabeto;
